...
def main():
    # 定时操作序列
     ...
     send_request("decreaseTemp", {"targetTemp": 22, "room_id": 3})
     time.sleep(10)
     ...
     time.sleep(30)
     send_request("decreaseTemp", { "targetTemp": 18, "room_id": 3})


     send_request("changeFanSpeed", {"fanSpeed": 3, "room_id": 3})
     time.sleep(20)
    # send_request("decreaseTemp", { "targetTemp": 23, "room_id": 2})
     time.sleep(10)
     #send_request("changeFanSpeed", { "fanSpeed": 3, "room_id": 3})
     time.sleep(10)
