...
def main():
    ...
    send_request("test")
    time.sleep(10)  # 第一分钟
    send_request("increaseTemp", {"targetTemp": 24, "room_id": 101})
    time.sleep(0.1)
    ...
    time.sleep(10)  # 第3分钟
    send_request("test")
    send_request("increaseTemp", {"targetTemp": 25, "room_id": 102})
    time.sleep(0.1)
    ...
    time.sleep(9.8)  # 第4分钟
    send_request("test")
    send_request("increaseTemp", {"targetTemp": 27, "room_id": 103})
    time.sleep(0.1)
    ...
    time.sleep(10)  # 第7分钟
    send_request("test")
    send_request("increaseTemp", {"targetTemp": 24, "room_id": 105})
    time.sleep(10)  # 第8分钟
    send_request("test")
    time.sleep(10)  # 第9分钟
    send_request("test")
    send_request("increaseTemp", {"targetTemp": 28, "room_id": 101})
    time.sleep(0.1)
    send_request("increaseTemp", {"targetTemp": 28, "room_id": 104})
    time.sleep(0.1)
    ...
    time.sleep(10)  # 第11分钟
    send_request("test")
    send_request("changeFanSpeed", {"fanSpeed": 2, "room_id": 105})
    time.sleep(10)  # 第12分钟
    send_request("test")
    send_request("changeFanSpeed", {"fanSpeed": 3, "room_id": 102})
    time.sleep(10)  # 第13分钟
    send_request("test")
    time.sleep(10)  # 第14分钟
    send_request("test")
    ...
    send_request("togglePower", {"isOn": True, "room_id": 101})
    time.sleep(0.1)
    send_request("increaseTemp", {"targetTemp": 25, "room_id": 104})
    time.sleep(0.1)
    ...
    time.sleep(10)  # 第20分钟
    send_request("test")
    send_request("increaseTemp", {"targetTemp": 27, "room_id": 102})
    time.sleep(0.1)
    send_request("changeFanSpeed", {"fanSpeed": 2, "room_id": 102})
    time.sleep(0.1)
    send_request("togglePower", {"isOn": False, "room_id": 105})
    time.sleep(9.8)  # 第21分钟
    send_request("test")
    time.sleep(10)  # 第22分钟
    send_request("test")
    time.sleep(10)  # 第23分钟
